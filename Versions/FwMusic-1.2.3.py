...
import os.path
import LocalAPI_v10203_emf as LocalAPI
...
# Main Window
root = ttk.Window(title="FwMusic v1.2.3", themename="minty", size=(1000, 650), iconphoto='fwl.png')
...
def FwMusic_about():
    Messagebox.okcancel(title='About FwMusic', message='FwMusic is a simple music downloader.'
                                                       ...
                                                       'this product.\nVersion:'
                                                       '1.2.3\nAuthor: Flying374.\nWARNING:This the Last version of FwMusic 1\nFor more '
...
label2 = ttk.Label(root, text="v.1.2.3", font=('georgia', 20), bootstyle=PRIMARY)
